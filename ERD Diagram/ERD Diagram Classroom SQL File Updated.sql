...
-- -----------------------------------------------------
-- Table `classroom`.`instructor_teaches_course`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `classroom`.`instructor_teaches_course` ;

CREATE TABLE IF NOT EXISTS `classroom`.`instructor_teaches_course` (
  `instructor_instructor_id` INT NOT NULL,
  `course_course_id` VARCHAR(8) NOT NULL,
  PRIMARY KEY (`instructor_instructor_id`, `course_course_id`),
  INDEX `fk_instructor_has_course_course1_idx` (`course_course_id` ASC),
  INDEX `fk_instructor_has_course_instructor1_idx` (`instructor_instructor_id` ASC),
...
-- -----------------------------------------------------
-- Table `classroom`.`instructor_teaches_section`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `classroom`.`instructor_teaches_section` ;

CREATE TABLE IF NOT EXISTS `classroom`.`instructor_teaches_section` (
  `instructor_instructor_id` INT NOT NULL,
  `section_sec_id` VARCHAR(8) NOT NULL,
  `section_semester` INT NOT NULL,
  `section_program` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`instructor_instructor_id`, `section_sec_id`, `section_semester`, `section_program`),
  INDEX `fk_instructor_has_section_section1_idx` (`section_sec_id` ASC, `section_semester` ASC, `section_program` ASC),
  INDEX `fk_instructor_has_section_instructor1_idx` (`instructor_instructor_id` ASC),
  CONSTRAINT `fk_instructor_has_section_instructor1`
    FOREIGN KEY (`instructor_instructor_id`)
    REFERENCES `classroom`.`instructor` (`instructor_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_instructor_has_section_section1`
    FOREIGN KEY (`section_sec_id` , `section_semester` , `section_program`)
    REFERENCES `classroom`.`section` (`sec_id` , `semester` , `program`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
